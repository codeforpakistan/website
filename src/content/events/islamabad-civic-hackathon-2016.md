...
- **First Place**: [Dastaweezat](https://devpost.com/software/dastawezat), an app that allows students to apply to multiple universities with a single application form.
- **Second Place**: [Chota Ustaad](https://devpost.com/software/chota-ustaad), an app that connects students with online tutors for easy and improved access to education.
- **Third Place **went to three teams:

- [Bijli Pe Nazar](https://devpost.com/software/bijli-pe-nazar), a solution that collects data on household electricity consumption to enable citizens to take energy efficient decisions
- [Shafaaf Voting](https://devpost.com/software/shafaaf-voting), a digital voting app to curb riggings in election
- [Baagh Baagh](https://devpost.com/software/bagh-bagh), a mobile app for donating and sharing plants from your garden.

- The **Audience Favorite **award went to [No Food Wasted](https://devpost.com/software/feedpakistan), an online website for diverting food wastage towards feeding poor people.

See all the creative ideas and applications that the participants created at the hackathon: [http://isbhacks2016.devpost.com/submissions](http://isbhacks2016.devpost.com/submissions)
...
Many thanks to our sponsors [National Endowment for Democracy](http://www.ned.org/), [Arbisoft](http://codeforpakistan.us3.list-manage1.com/track/click?u=9d9872da59962954cf1b5cac1&id=3106effa47&e=5d624fcefd) and Telenor Pakistan, and our partners, Media Matters for Democracy, Teradata, Invest2Innovate, Google Developers Group (GDG) Islamabad, Microsoft, The Nest I/O, Global Shapers Islamabad, IRIS.pk, Media Clicks, MediaClub – GIki, Smile Network, Clary Icon, Red Bull, and Second Cup Pakistan.
...
- [Dawn](http://www.dawn.com/news/1271809/code-for-pakistan-brings-technology-geeks-to-solve-civic-and-social-issues) & [Dawn](http://www.dawn.com/news/1275340)
- [Express Tribune](http://tribune.com.pk/story/1144531/social-civic-problems-tech-savvy-minds-offer-innovative-solutions/)
- [TechJuice](https://www.techjuice.pk/islamabad-civic-hackathon-building-change-with-code/)
- [ProPakistani](https://propakistani.pk/2016/07/18/islamabad-hosts-its-second-annual-civic-hackathon/)
