...
- The **first prize **went to *Team Satisfire* for their project, [Ghirasti](https://devpost.com/software/ghirasti), a platform for women to share their skills, regain control of their free time, while developing a strong social network within their communities, gaining financial freedom, and building their confidence.
- **Second prize **was awarded to *Team BioBeing*, for their [mobile app](https://devpost.com/software/biobeing) designed for collection of waste cooking oil from restaurants, hotels, and households, and their idea to convert it into biodiesel.
- **Third prize **went to Team *Solution Seekers*, who developed a mobile application, [Faryad](https://devpost.com/software/faryad), that connects its users to a number of NGOs, doctors and hospitals to request them to raise funds on their behalf in cases of emergencies.
