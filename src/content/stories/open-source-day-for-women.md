...
Worldwide, only 11% of contributions made to open source software are by women. In Pakistan, the top [1,000 github profiles](https://github.com/search?utf8=%E2%9C%93&q=location%3Apakistan) returned don't include even 10 female developers. Creating awareness is the first step towards addressing this imbalance.
...
If you've made it this far in the article, then you must leave really like open source! [Here](https://guides.github.com/activities/contributing-to-open-source/) and [here](http://up-for-grabs.net/) are a couple of resources that will help you in getting started on making contributions to open source.

Once you have a handle on how to make a contribution, you can take a look though the [github repositories](https://github.com/codeforpakistan/) Code for Pakistan has or this [issues tracker](http://civicissues.codeforamerica.org/geeks/civicissues) where code for America posts open issues. Happy open-sourcing
