...
To overcome these issues, [Khyber Paktunkhwa Traffic Police](http://www.ptpkp.gov.pk/) (KP Traffic Police) has once again joined hands with the civic hackers of the area to develop a complete solution under the 3rd batch of the [KP Civic Innovation Fellowship Program](http://codeforpakistan.org/programs/fellowship/). Previously, the traffic police has already deployed another solution under the [second batch](http://codeforpakistan.org/blog/2016/02/08/the-2015-2016-kp-civic-innovation-fellowship-program/) of the same program to [plot traffic violations onto a heat map](http://codeforpakistan.org/blog/portfolio-item/kp-traffic/) which in return has saved millions of rupees, time and efforts of the Traffic Police Department.

The Traffic Police Department decided to handover the project to the KP Civic Innovation Fellowship Program, which is a joint venture of [Code for Pakistan](http://www.codeforpakistan.org/), [Khyber Pakhtunkhwa Information Technology Board (KPITB)](http://kpitb.gov.pk/) and the World Bank. The purpose of the Fellowship program is to bridge the gap between the government and the general public via civic innovation to bring a positive change in society. The development of the project was handed over to one of the [teams](http://codeforpakistan.org/blog/2017/05/22/kp-civic-innovation-fellowship-program-2017/) in the Fellowship Program and will be launched before the end of Fellowship cycle in September 2017.

> The Traffic Police Department feels very privileged to work with the KP Civic Innovation Fellowship Program and Code for Pakistan.

_Muhammad Aftab, Deputy Director IT, KP Traffic Police_
...
-   **Complaints Module** — Where the public will be able to report complaints about problems, potential traffic violations and corrupt traffic wardens instantly.
...
-   **Traffic Education** — This module will contain different graphical symbols meant to be used to educate people about traffic rules and regulations.
...
-   **Emergency contacts** — This module will allow the public to find a nearby rescue personnel to overcome any problems that they may be facing while travelling.
