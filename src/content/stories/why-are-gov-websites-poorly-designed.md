...
1.  **Varying Technical Capabilities**: Different government departments have varying levels of technical expertise. While a few develop their own digital tools, most rely on outsourcing to vendors or IT boards.
2.  **Lack of Standards**: There are no universal guidelines for user experience, accessibility, or performance in government digital tools. As a result, quality often takes a backseat.
3.  **Limited Expertise in Design Evaluation**: Identifying design problems requires technical know-how, which is often lacking in government teams.
...
If you’re curious and want to contribute, email us at [masna@codeforpakistan.org](mailto:masna@codeforpakistan.org).
