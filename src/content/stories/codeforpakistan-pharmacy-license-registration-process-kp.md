...
Illegal pharmacies are a big problem in Pakistan. According to Pakistan Pharmacist Association, for approximately 4,000 licensed pharmacies in Pakistan, there are [100,000 other illegal merchants](https://dailytimes.com.pk/73155/counterfeit-medication-proving-fatal-to-thousands-in-kp/) selling medicines.
...
In KP, there are 50 drug inspectors who are required to check around 12,000 registered chemist shops. According to officials, illegal drug stores outnumber the registered ones. An [independent report](https://www.dawn.com/news/1492575) by DG (Health) in 2019 revealed that there were 2,500 registered drugstores in Peshawar but there was no official record for them. Furthermore, 600 drug licences issued in Peshawar were [found](https://www.dawn.com/news/1504133/supply-of-fake-smuggled-drugs-from-peshawar-sets-alarm-bells-ringing) to be fake on verification.

From 2014 to 2018, [reportedly](https://www.dawn.com/news/1504133/supply-of-fake-smuggled-drugs-from-peshawar-sets-alarm-bells-ringing) 66,879 inspections were carried out, 1,471 drugs were declared substandard and 146 spurious, 2,322 pharmacies were sealed, 72 FIRs were registered and courts decided 544 cases with the convicts being awarded fines and jail sentences.
...
-   Users could easily apply for a new license, or renew existing licenses
-   Existing issued licenses could be verified for authenticity
-   The department could check duplicate and fake licenses
-   Users could track the progress of obtaining licenses
...
-   **Pharma Council Module:** Designed for Pharma Council to verify qualified person/pharmacist(s) credentials
-   **Application Module:** For pharmacies, drug store owners, and proprietors to apply for a license
-   **DG Drug Module:** A separate control panel has been developed for the DG Drugs Department for their due diligence and oversight
-   **Inspector Module:** For drug inspectors, a module has been developed to oversee pending site visits and approvals
-   **Admin Module:** The admin module has been developed for the department to check data in all user roles and ensure data entry transparency and authenticity
