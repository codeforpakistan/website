...
#### Women represented from some of the regions most remote areas — and with better connectivity:

The 7th cycle is the first-ever Fellowship cycle in which women interns from some of KP’s most remote areas had the opportunity to collaborate directly with and learn from the Fellows in the development of digital solutions for government departments of KP. Given the social challenges that most women face in KP — such as the conservative culture and inability to work alongside men — our interns had the option to contribute remotely. Thanks to our partners at [**PTCL/Ufone**](https://codeforpakistan.medium.com/ufone-4g-provides-wifi-devices-to-interns-of-kp-women-civic-program-744a52e9b27c), who donated free wifi devices to the program, our women interns could work with the Fellowship cohort, seamlessly.
...
#### Working with government to make sure the solutions stick
