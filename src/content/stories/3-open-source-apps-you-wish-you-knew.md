...
This online platform has digitized the process of applying for licensure of pharmaceuticals, their renewal, and verification in the KP province. Pharmacy store owners no longer have to spend valuable hours waiting for their applications to be processed. Thanks to this digitization, the Health Department KP can make sure that all pharmaceutical licenses issued for various medicines are valid just by verifying them through the platform. And knowing about this streamlined system, KP citizens can be assured of safe and quality medication whenever they go to a local drug store.

So far, hundreds of users within Khyber Pakhtunkhwa have benefitted from the solutions shown above. All of them are open source, so you too can take their source codes and modify them to fit the requirements of your region!

To find these applications and make them your own, check out Code For Pakistan's [**Github**](https://github.com/codeforpakistan) page now.

Written by: Hira Irfan & Ibraheem Saleem
