...
- Knowledge with AI stacks, Excellent at Prompt Engineering
- Working Knowledge and experience of Python, JavaScript, Typescript frameworks (e.g. Angular, React, Node.js, Flask, Django, FASTApi)
- Familiarity with databases (e.g. MySQL, MongoDB, Vector Database), web servers (e.g. Apache, NGINX), and UI/UX design
...
- Experience with microservices design pattern
